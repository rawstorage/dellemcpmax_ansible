...
short_description: 
    -Module to delete a Port Group.  

requirements:
    -Port Group must exist for module to Pass, also Port Group must not be in 
    any existing masking view, this is intended to delete Port Groups that 
    are no longer in use and as such Caution should be exercised.
