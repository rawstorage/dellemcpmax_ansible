...
def main():
    ...
    if module.params['target_sgname'] in sglist:
        rep.unlink_gen_snapshot(sg_id=module.params['sgname'],
                              snap_name=module.params['snapshotname'],
                              unlink_sg_name=module.params['target_sgname'],
        ...
        module.fail_json(msg='Target Storage Group Does Not Exist')
